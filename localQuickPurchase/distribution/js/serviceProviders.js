...
$(function(){
	...
	var data={
			...
			"init":function(obj){
				...
				$.post("/localQuickPurchase/dApplicationAction/findServerShop",param,function(result){
					if(result.code==200){
						...
						for(var i = 0;i<shops.length;i++){
							...
							html+='<a href="serviceGoods.jsp?masterSeq='+shops[i].seq+'" class="a_serviceGoods" >';
