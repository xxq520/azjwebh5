...
/*日期2017-01-01 12:23:22格式转时间戳*/
function datetrans(datetime) {
    var timestamp = new Date(datetime.replace(/-/g, '/')).valueOf();
    return timestamp;
}
...
function downloadfile(obj, type) {
    ...
    var fileurl = $(obj).attr("data-href");
    if (isappwebview) {
        action.downLoadFile(fileurl,type);
    } else {
