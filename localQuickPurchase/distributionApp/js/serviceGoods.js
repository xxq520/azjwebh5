...
$(function(){
	...
	var initData={ 
			...
			"hasNextPage":true,
			//参数
			"param":{"masterSeq":masterSeq,"distributorSeq":seq,"pageSize":10,"pageIndex":1,"keyWord":'',"categoryId":''},
			"functions":{  
				"init" :function(json,obj){
					var goods = json.list;
					var html = "";
					for(var i = 0;i<goods.length;i++){
						var goodsProStandards = goods[i].distributionGoods.goodsProStandard;
...
//						html+='<p class="ltic-price">价格：'+(goods[i].distributionGoods.distributionPrice).toFixed(2)+'元/'+goods[i].distributionGoods.unit+'</p>';
						html+='<p class="ltic-price">价格：'+getDistributionPrice(goodsProStandards).toFixed(2)+'元/'+goods[i].distributionGoods.unit+'</p>';
						html+='</div>';
						html+='</div>';
						/*if(goods[i].isFavorites)
							html+='<a ><span goodsId="'+goods[i].distributionGoods.goodsId+'" isFavorites="'+goods[i].isFavorites+'" class="collect mui-tab-method yes" style="color:#999999"  data-state="collect" ><i class="iconfont icon-xin" ></i>移出我的店铺</span></a>';
						else
							html+='<a ><span goodsId="'+goods[i].distributionGoods.goodsId+'" isFavorites="'+goods[i].isFavorites+'" class="collect mui-tab-method yes" style="color:#999999"  data-state="collect" ><i class="iconfont icon-xin" style="color:#999999"></i>加入我的店铺</span></a>';*/
...
//						html+='<p class="ltic-price">价格：'+(goods[i].distributionGoods.distributionPrice).toFixed(2)+'元/'+goods[i].distributionGoods.unit+'</p>';
	...
	mui('body').on('tap','.seaBtn',function(){
		...
		var param = {"masterSeq":masterSeq,"distributorSeq":seq,"pageSize":10,"pageIndex":1
