function countdown(end,seckillId){
    // start 倒计时开始时间 
    ...
    console.log(time_distance);
     ...
     var timerId = setInterval(function(){
		if(time_distance <= 0 ){
			...
			updateSeckillGoodsInfo(seckillId);
			return false;
		}
		time_distance--;
		// 时
 ...
 * @param seckillId
 */
function updateSeckillGoodsInfo(seckillId) {
    $.ajax({
        type: 'GET',
        url: '/localQuickPurchase/sgMongoAction/endTimer',
