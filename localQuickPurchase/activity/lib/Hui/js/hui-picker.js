...
function huiPickerHide(id){hui('.hui-picker').hide();hui.dialogClose();}
function huiPicker(selector, callBack){
	...
	'<div class="hui-fl hui-button-small" style="color:#999999;" onclick="huiPickerHide();">取消</div>'+
	'<div class="hui-fr hui-button-small hui-primary" id="HUI_PickerConfirm'+HUI_PickerId+'">确定</div>'+
'</div>'+
...
'<div class="hui-picker-line"></div>';
	...
	HUI_PickerId++;
	this.pickerBtn.click(function(){hui('.hui-picker').hide(); thisObj.pickerMain.show();hui.dialogBase();});
