    ...
    return function (t) {
        ...
        e.default = {
            ...
            methods: {
                ...
                handleTouchMove: function (t) {
                    if (!(this.startY < this.$el.getBoundingClientRect().top && this.startY > this.$el.getBoundingClientRect().bottom) && t.cancelable) {
            ...
            var u = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                ...
                w = function () {
                    ...
                    return d(t, [{
                        ...
                        value: function () {
                            var t = this;
                            return this.attempt > this.options.attempt - 1 && this.state.error ? void (this.options.silent || console.log("error end")) : this.state.loaded || x[this.src] ? this.render("loaded", !0) : (this.render("loading", !1), this.attempt++ , this.record("loadStart"), void v({
                                src: this.src
                            }, function (e) {
